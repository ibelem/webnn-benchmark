<template>
  <section>
    <h2
      class="has-text-primary is-size-5-desktop is-size-6-mobile is-size-5-tablet mb"
    >
    ...
    <div class="columns">
      <div
        v-for="task in tasks"
        v-if="task.category == 'Image Classification' && task.id < 10"
        :key="task.id"
        class="column is-mobile is-one-third-tablet is-one-third-desktop is-one-quarter-widescreen is-one-quarter-fullhd"
      >
        <b-collapse class="card">
          ...
          <div class="card-content">
            <div class="content lh">
              ...
              <ul>
                <li>
                  Neural Network: {{ task.model_name }} {{ task.model_version }}
                </li>
                ...
                <li>
                  Backend:
                  <span v-for="(b, index) in task.backend" :key="index">
                    {{ b }}
                  </span>
                </li>
              </ul>
          ...
          <footer class="card-footer">
            <a
              class="card-footer-item button is-primary-gradient"
              :href="'../test/' + task.url"
            >
              Run Test
            </a>
    ...
    <div class="columns">
      <div
        v-for="task in tasks"
        v-if="task.category == 'Object Detection'"
        :key="task.id"
        class="column is-mobile is-one-third-tablet is-one-third-desktop is-one-quarter-widescreen is-one-quarter-fullhd"
      >
        <b-collapse class="card">
    ...
    <h2
      class="has-text-primary is-size-5-desktop is-size-6-mobile is-size-5-tablet mb"
    >
      Tests: Human Pose Estimation
    </h2>
    <div class="columns">
      <div
        v-for="task in tasks"
        v-if="task.category == 'Human Pose Estimation'"
        :key="task.id"
        class="column is-mobile is-one-third-tablet is-one-third-desktop is-one-quarter-widescreen is-one-quarter-fullhd"
      >
        <b-collapse class="card">
      ...
      tasks: [
        {
          ...
          test: {
            ...
            image: [
              '../img/mobilenet/bee_eater.jpg',
              '../img/mobilenet/traffic_light.jpg',
              '../img/mobilenet/pinwheel.jpg'
            ]
          },
        ...
        },
        {
          ...
          label: '../model/mobilenet/labels.txt',
          description:
            'MobileNetV2 improves the state of the art performance of mobile models. Loading MobileNet model v2.0 trained by ImageNet in TensorFlow Lite format, constructs and inferences it by WebML API. ',
          model_version: 'v2.0',
          accuracy: '91.0%',
          model_size: '14.0Mb',
        ...
        },
        {
          ...
          description:
            'A light-weight CNN providing Alexnet level accuracy with 50X fewer parameters. Loading SqueezeNet model trained by ImageNet in ONNX format, constructs and inferences it by WebML API.',
          model_version: 'v1.1',
          accuracy: '79.12%',
          model_size: '5.0Mb',
          ...
          test: {
            resolution: '224 x 224 px',
            image: [
              '../img/squeezenet/jeep.jpg',
              '../img/squeezenet/wallaby.jpg',
              '../img/squeezenet/panda.jpg'
            ]
          }
        },
        {
          ...
          description:
            'Inception-v3 is trained for the ImageNet Large Visual Recognition Challenge. Loading Inception-v3 model trained by ImageNet in TensorFlow Lite format, constructs and inferences it by WebML API.',
          model_version: 'v3',
          accuracy: '93.8%',
          model_size: '95.3Mb',
        ...
        //   },
        {
          ...
          label: '../model/posenet/',
          description:
            'PoseNet is a machine learning model that allows for Real-time Human Pose Estimation which can be used to estimate either a single pose or multiple poses. This task loads a pretrained PoseNet model, constructs and infers it by WebML API.',
