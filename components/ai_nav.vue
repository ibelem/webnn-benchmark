  ...
  <nav class="navbar is-white">
    <div class="navbar-brand">
      <a class="navbar-item" href="/">
        ...
        >
          <defs>
            <clipPath id="_clipPath_NaafQerNX9oYqPYPML1NpC0noDNNJjZs">
          ...
          <g clip-path="url(#_clipPath_NaafQerNX9oYqPYPML1NpC0noDNNJjZs)">
            <rect
              ...
              fill-opacity="0.9"
            />
            <g transform="matrix(0.25,0,0,0.25,4,-3)">
              <text
                id="l1"
                transform="matrix(1,0,0,1,0,180)"
                style="font-size:200px;fill:rgba(222, 12, 101, 1.0);stroke:none;"
              >
                a
              </text>
            </g>
            <g transform="matrix(0.25,0,0,0.25,28.00,-3)">
              <text
                id="l2"
                transform="matrix(1,0,0,1,0,180)"
                style="font-size:200px;fill:rgba(222, 12, 101, 1.0);stroke:none;"
            ...
            <g transform="matrix(0.25,0,0,0.25,37.00,-3)">
              <text
                id="l3"
                transform="matrix(1,0,0,1,0,180)"
                style="font-size:200px;fill:rgba(222, 12, 101, 1.0);stroke:none;"
            ...
            <g transform="matrix(0.25,0,0,0.25,79.25,-3)">
              <text
                id="l4"
                transform="matrix(1,0,0,1,0,180)"
                style="font-size:200px;fill:rgba(222, 12, 101, 1.0);stroke:none;"
            ...
            <g transform="matrix(0.25,0,0,0.25,104,-3)">
              <text
                id="l5"
                transform="matrix(1,0,0,1,0,180)"
                style="font-size:200px;fill:rgba(222, 12, 101, 1.0);stroke:none;"
            ...
            <g transform="matrix(0.25,0,0,0.25,120,-3)">
              <text
                id="l6"
                transform="matrix(1,0,0,1,0,180)"
                style="font-size:200px;fill:rgba(222, 12, 101, 1.0);stroke:none;"
            ...
            <g transform="matrix(0.25,0,0,0.25,147.25,5.5)">
              <text
                class="l7"
                transform="matrix(1,0,0,1,0,64.8)"
                style="font-size:72px;fill:rgba(222, 12, 101, 1.0);stroke:none;"
              >
                for
              </text>
            </g>
            <g transform="matrix(0.25,0,0,0.25,175.5,5.25)">
              <text
                class="l7"
                transform="matrix(1,0,0,1,0,64.8)"
                style="font-size:72px;fill:#FFFFFF;stroke:none;"
              >
                w
              </text>
            </g>
            <g transform="matrix(0.25,0,0,0.25,189.25,5.25)">
              <text
                class="l7"
                transform="matrix(1,0,0,1,0,64.8)"
                style="font-size:72px;fill:#FFFFFF;stroke:none;"
            ...
            <g transform="matrix(0.25,0,0,0.25,199.75,5.25)">
              <text
                class="l7"
                transform="matrix(1,0,0,1,0,64.8)"
                style="font-size:72px;fill:#FFFFFF;stroke:none;"
...
svg #l6 {
  animation: stroke-offset 1s ease-out;
}
