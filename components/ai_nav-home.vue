  ...
  <nav class="navbar">
    <div class="navbar-brand">
      <nuxt-link class="navbar-item" to="/">
        ...
        >
          <defs>
            <clipPath id="_clipPath_3kp6XmP9DdK05Pm9I8veyngzPjTE0jr3">
              <rect width="224" height="56" />
            </clipPath>
          </defs>
          <g clip-path="url(#_clipPath_3kp6XmP9DdK05Pm9I8veyngzPjTE0jr3)">
            <rect
              x="172.75"
              y="5.5"
              width="40"
            ...
            <g transform="matrix(0.25,0,0,0.25,4,-3)">
              <text
                ...
                style="font-size:200px;fill:#FFFFFF;stroke:none;"
              >
                a
              </text>
            </g>
            <g transform="matrix(0.25,0,0,0.25,27.00,-3)">
              <text
                id="l2"
                transform="matrix(1,0,0,1,0,180)"
                style="font-size:200px;fill:#FFFFFF;stroke:none;"
            ...
            <g transform="matrix(0.25,0,0,0.25,35.00,-3)">
              <text
                id="l3"
                transform="matrix(1,0,0,1,0,180)"
                style="font-size:200px;fill:#FFFFFF;stroke:none;"
